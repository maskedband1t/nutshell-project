...
{
  "$end", "error", "$undefined", "BYE", "CD", "STRING", "ALIAS", "LS",
  "END", "$accept", "cmd_line", YY_NULLPTR
};
#endif
...
#line 29 "nutshparser.y"
                                                {exit(1); return 1; }
#line 1323 "nutshparser.tab.c"
    break;

  case 3:
#line 30 "nutshparser.y"
                                                {runCD((yyvsp[-1].string)); return 1;}
#line 1329 "nutshparser.tab.c"
    break;
