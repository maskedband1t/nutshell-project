...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TILDE = 7,                      /* TILDE  */
  YYSYMBOL_END = 8,                        /* END  */
  YYSYMBOL_YYACCEPT = 9,                   /* $accept  */
  YYSYMBOL_cmd_line = 10                   /* cmd_line  */
};
...
static const char *const yytname[] =
{
  ...
  "ALIAS", "TILDE", "END", "$accept", "cmd_line", YY_NULLPTR
};
...
#line 25 "nutshparser.y"
                                                {exit(1); return 1; }
#line 1084 "nutshparser.tab.c"
    break;

  case 3: /* cmd_line: CD STRING END  */
#line 26 "nutshparser.y"
                                                {runCD((yyvsp[-1].string)); return 1;}
#line 1090 "nutshparser.tab.c"
    break;

  case 4: /* cmd_line: CD END  */
#line 27 "nutshparser.y"
                                       {runCDHome("~"); return 1;}
#line 1096 "nutshparser.tab.c"
    break;

  case 5: /* cmd_line: CD TILDE END  */
#line 28 "nutshparser.y"
                                       {runCDHome((yyvsp[-1].string)); return 1;}
#line 1102 "nutshparser.tab.c"
    break;

  case 6: /* cmd_line: ALIAS STRING STRING END  */
#line 29 "nutshparser.y"
                                                {runSetAlias((yyvsp[-2].string), (yyvsp[-1].string)); return 1;}
#line 1108 "nutshparser.tab.c"
    break;

  case 7: /* cmd_line: STRING END  */
#line 30 "nutshparser.y"
                                        {return 1;}
#line 1114 "nutshparser.tab.c"
    break;


#line 1118 "nutshparser.tab.c"
